...
const Presentacion = ({
  ...
  return (
    <div className='flex flex-col md:flex-row justify-between items-center w-full px-4 md:px-10 absolute gap-8 md:gap-0'>
        <div className='rounded-sm flex flex-col w-full md:w-[450px] opacity-0' ref={box1Ref}>
            <span className='text-4xl md:text-6xl' ref={primerTitulo}>Desarrollador</span>
            <span className='text-4xl md:text-6xl text-[#d833f5]' ref={segundoTitulo}>Front-end</span>
            <span className='text-4xl md:text-6xl text-[#a023b6]' ref={tercerTitulo}>Android</span>
            <span className='text-4xl md:text-6xl text-[#6B107B]' ref={cuartoTitulo}>Backend</span>
            <div className='flex flex-wrap gap-2 md:gap-3 mt-2'>
                <div className='rounded-xl p-2' style={{ background:'#d656ec', backdropFilter:'blur(10px)'}} ref={recuadro1ref}>Nexjs</div>
                <div className='rounded-xl p-2' style={{ background:'#d833f5', backdropFilter:'blur(10px)'}} ref={recuadro2ref}>React Native</div>
                <div className='rounded-xl p-2' style={{ background:'#a023b6', backdropFilter:'blur(10px)'}} ref={recuadro3ref}>Node</div>
                <div className='rounded-xl p-2' style={{ background:'#6B107B', backdropFilter:'blur(10px)'}} ref={recuadro4ref}>Java</div>
            </div>
        </div>
        <div className="tech-icons-container w-full md:w-auto" ref={box2Ref}>
          {/* Primera fila de iconos - recuadro5ref */}
          <div className="tech-icons-row flex flex-wrap justify-center gap-2 md:gap-4 opacity-0 mb-4" ref={recuadro5ref}>
          ...
          <div className="tech-icons-row flex flex-wrap justify-center gap-2 md:gap-4 opacity-0 mb-4" ref={recuadro6ref}>
            <div className="tech-icon flex flex-col items-center">
          ...
          <div className="tech-icons-row flex flex-wrap justify-center gap-2 md:gap-4 opacity-0" ref={recuadro7ref}>
            <div className="tech-icon flex flex-col items-center">
